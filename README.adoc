= WokeLang SSG - Static Site Generator for wokelang.org
:toc:
:toclevels: 3

== Overview

WokeLang SSG is a static site generator written *in WokeLang itself*, serving as both:

1. **Production SSG** - Generates the official wokelang.org website
2. **Language Demo** - Showcases WokeLang's consent-driven computing, gratitude system, and emotive programming
